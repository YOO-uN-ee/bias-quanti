...
for i in os.listdir(f'/home/yaoyi/pyo00005/quanti_bias/test_results/{location}/pkl'):
    try:
        with open(os.path.join(f'/home/yaoyi/pyo00005/quanti_bias/test_results/{location}/pkl', i), 'rb') as handle:
...
directory_name = f'/home/yaoyi/pyo00005/quanti_bias/test_results/{location}'
...
for i in os.listdir(os.path.join(directory_name, 'csv')):
    ...
    ).group_by('target_type').agg([pl.all()]).sort('target_type').with_columns(
